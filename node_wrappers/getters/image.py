...
class LivepeerImageJobGetter(LivepeerJobGetterBase):
    ...
    def get_image_job_result(self, job_id, unique_id=None):
        # Delegate all logic to the base class handler, no longer need to pass unique_id
